    ...
    <div className="relative flex w-dvw flex-col items-center">
      ...
      <div className="relative flex h-[70dvh] w-full items-center justify-center p-8">
        ...
        <div className="container z-10 flex h-full w-full">
          ...
          <div className="flex h-full w-2/5 items-center justify-center pr-8">
            <form
              action=""
              className="flex h-fit w-4/5 flex-col gap-6 rounded-lg bg-gray-50 p-6 shadow-md"
            >
              <div className="">
                <label
              ...
              <div className="">
                ...
                <input
                  className="focus:shadow-outline w-full appearance-none rounded border px-3 py-2 leading-tight text-gray-700 placeholder:font-normal focus:outline-none"
                  id="movingDate"
                  type="date"
                />
              </div>
              <div className="flex items-center justify-between">
                <button
                  className="focus:shadow-outline rounded-full bg-red-500 px-8 py-4 font-normal text-white hover:bg-blue-700 focus:outline-none"
                  type="submit"
                >
                  Get Moving!
                </button>
      ...
      {/* Info */}
      <div className="container flex h-fit w-full flex-col items-center gap-8 py-20">
