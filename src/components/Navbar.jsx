  ...
  return (
    <div className="flex h-fit w-full flex-row items-center justify-between bg-red-600 p-4 md:px-12 md:py-6">
      ...
      <div
        ...
        className="h-18 flex items-center justify-center lg:hidden"
      >
        <svg
      ...
      {openMenu && (
        <div className="fixed left-0 top-0 z-50 h-dvh w-dvw">
          ...
          <span onClick={handleOpenMenu} className="absolute right-4 top-5">
            <div className="h-18 flex items-center justify-center rounded lg:hidden">
              <svg
                xmlns="http://www.w3.org/2000/svg"
                fill="none"
                viewBox="0 0 24 24"
