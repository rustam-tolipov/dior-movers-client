      ...
      <div className="container flex w-full justify-between">
        <div className="flex w-2/6 flex-col gap-2">
          ...
          <p className="text-left text-sm text-gray-600 lg:text-base">
            Ducimus suscipit inventore non voluptas accusantium deleniti,
            corrupti impedit adipisci, maiores hic minima tenetur unde aliquam
            voluptate! Non, facilis accusamus?
          </p>
          <button className="mb-6 mt-6 w-fit rounded-full bg-gray-950 px-3 py-1 text-sm font-medium text-gray-100 lg:mt-auto lg:px-6 lg:py-2 lg:text-base">
            Contact Us
          </button>
        </div>
        <div className="flex h-full w-7/12 lg:w-3/6">
          <div className="h-full w-full">
            <div className="ml-auto w-fit">
              ...
              <ul className="flex flex-col gap-2">
                <li className="text-sm">How does it work</li>
          ...
          <div className="h-full w-full">
            <div className="ml-auto w-fit">
              ...
              <ul className="flex flex-col gap-2">
                <li className="text-sm">Moving</li>
                <li className="text-sm">Cleaning</li>
                <li className="text-sm">Handyman</li>
              </ul>
            </div>
          </div>
          <div className="h-full w-full">
